<template>
  <div class="body_wrapper" id="footer">
    <div class="footer-section">
      <div class="pre-title">Got a project? Need help?</div>
      ...
      <div class="footer-section-cols">
        <div class="email">
          <p>Reach Out</p>
          <a href="mailto:contact.riaj@gmail.com"> contact.riaj@gmail.com </a>
        </div>
        ...
        <div class="social-links">
          ...
          <div class="social-links__icons">
            <a href="https://www.linkedin.com/in/msriaj/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
            ...
            <a
              href="
                https://www.instagram.com/fake.sohel/
                "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.facebook.com/CloUdNuMbEr404/"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
...
.body_wrapper {
  ...
  color: #6b645c;
  overflow: hidden;
  background-image: linear-gradient(180deg, #f7f7f700 0%, #3d38382d 100%);
  .footer-section {
    .pre-title {
      font-size: 1.5rem;
      font-weight: 500;
